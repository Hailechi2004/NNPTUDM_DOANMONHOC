...
router.get('/login', guestOnly, function(req, res) {
...
router.get('/register', guestOnly, function(req, res) {
...
router.post('/register', guestOnly, registerValidation, validateResult, async function(req, res) {
  try {
...
router.post('/logout', checkLogin, function(req, res) {
  ...
  res.redirect('/auth/login?success=%C4%90%C3%A3%20%C4%91%C4%83ng%20xu%E1%BA%A5t');
});
